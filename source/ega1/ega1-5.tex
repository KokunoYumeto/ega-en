...
show that $\Delta_X(X)$ is locally closed in $X\times_S X$.\footnote{\emph{[Trans.] Published EGA~III.2, Errata and Addenda (list~2), item $\mathrm{Err}_{\mathrm{III}},10$, explicitly identifies this gap and gives the affine-local proof translated here.}}
For a correct proof, it suffices to use \sref{I.4.2.4}[a]:
for every $x\in X$ and every affine neighbourhood $U$ of $x$ in $X$,
$U\times_S U$ is an affine neighbourhood of $\Delta_X(x)$.
