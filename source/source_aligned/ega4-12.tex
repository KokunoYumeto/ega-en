...
\label{IV.12.1.1}
Let $f:X\to Y$ be a morphism locally of finite presentation, $\sh{F}$ an $\sh{O}_X$-Module $f$-flat and of finite presentation, $\Phi$ a finite subset of $\mathbf{Z}\cup\{\pm\infty\}$, $k$ an integer with $k\geqslant 1$.
